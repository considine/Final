...
class graphics {
	private:
		...
		SDL_Surface* whichSurface[8]; //array of five different surfaces which might be loaded
		SDL_Surface* birdA[7]; //array of five different surfaces which might be loaded
